...
public class ModBlocks {
    ...
    public static final RegistryObject<LiquidBlock> SEWAGE_BLOCK = BLOCKS.register("sewage",
    ...
    public static final RegistryObject<Block> SIMPLE_FLOWER = registerBlock("simple_flower",
